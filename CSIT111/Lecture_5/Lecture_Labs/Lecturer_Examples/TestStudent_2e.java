...
//
// File name: TestStudent_2e.java
//
// To design a complete class that describe the student class
// Explore the use of this to access the instance information
// Some updates to mutator methods
// Most of the user defined method do not need the parameters
// Explore some private methods
...
class TestStudent_2e
{
	...
	public static void main (String [ ] args)
	{
		...
		s.setId (id);
		s.setGender(gender);
		s.setTwoSubjects(subject1, subject2);
		s.setTwoMarks (mark1, mark2);
		
		// We call the getAverage and getFinalMark methods
		// to get the information
		double average = s.getAverage (); // actual marks are mark1 and mark2
