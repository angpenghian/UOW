...
//
// File name: TestStudent_4a.java
//
// To design a complete class that describe the student class
//
// Assign an object to another object, ideally using the copy constructor
//
// Explore more on "this" i.e. constructor can call other constructor
...
class Student
{
	...
	public Student (Student s)
	{
		...
		*/
		...
		this (s.name, s.id, s.gender, s.subject1, s.subject2, s.mark1, s.mark2);
	}
...
class TestStudent_4a
{
	public static void main (String [ ] args)
	{
		...
		// Use copy constructor to duplicate (clone) another object
		Student ss = new Student (s);
		
		System.out.println ("\nStudent ss");
		ss.processInfo ();
		
		// We update the marks of Student ss
		ss.setTwoMarks (100.0, 100.0);
		
		System.out.println ("\nStudent ss");
		ss.processInfo ();
		
		// The marks for Student s also updated
		System.out.println ("\nStudent s");
		s.processInfo ();
