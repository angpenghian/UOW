...
//
// Introduce a static variable defined inside a class, i.e. Student class
...
class TestStudent_5
{
	public static void main (String [ ] args)
	{
		...
		Student s = new Student (name, gender, subject1, subject2, mark1, mark2);
		
		// Process the student info
		System.out.println ("\nStudent s");
		s.processInfo ();
		
		// Construct another object using the default constructor
