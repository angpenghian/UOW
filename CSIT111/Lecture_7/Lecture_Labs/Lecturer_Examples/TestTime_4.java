...
//
// File name: TestTime_4.java
//Explore the use of this to access to the constructor
// Notes: a private displayInfo method defined inside the class
// Assign an object to another object avoid using the assignment method
...
class TestTime_4
{
	public static void main (String [ ] args)
	{
		...
		t3.displayInfo("t3");
		t4.displayInfo("t4");
		System.out.println("=>The change of t3 will not affect t4");
		t5.displayInfo("t5");
		System.out.println("=>The change of t5 will affect t3");
